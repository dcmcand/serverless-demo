...
resource "aws_iam_policy" "inbound_bucket_policy" {
...
resource "aws_iam_policy" "outbound_bucket_role" {
...
output "inbound_bucket_policy_arn" {
    value = aws_iam_policy.inbound_bucket_policy.arn
}
output "outbound_bucket_policy_arn" {
    value = aws_iam_policy.outbound_bucket_role.arn
}